...
def main():
    ...
    model.load_state_dict(torch.load(os.path.join("model_checkpoints", "resnet50_amber-salad-1.pth")))
    ...
    # wandb
    project_name = "tmp_Transfer-test-checkpoint-{}-{}".format(args.src_domain, args.tgt_domain)
