...
def get_parser():
    ...
    parser.add("--seed", type=int, default=32)
...
def train(source_loader, target_train_loader, target_test_loader, model, optimizer, lr_scheduler, args, wandb, wandb_run_name):
    ...
    for e in range(1, args.n_epoch+1):
        ...
        if best_acc < test_acc:
            ...
            stop = 0
            torch.save(model.state_dict(), os.path.join("raphael_model_checkpoints", "resnet50_{}.pth".format(wandb_run_name)))
...
def main():
    ...
    if not os.path.exists("raphael_model_checkpoints"):
        os.makedirs("raphael_model_checkpoints")
    ...
    # wandb
    project_name = "tmp-Raphael-{}-{}".format(args.src_domain, args.tgt_domain)
    ...
    train(source_loader, target_train_loader, target_test_loader, model, optimizer, scheduler, args, wandb, wandb_run_name)
